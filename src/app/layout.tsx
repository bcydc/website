...
const identity = {
  ...
  description:
    "A collective of over 450 high school students in British Columbia with a shared passion for computer science, software development, robotics, and technology.",
};
