...
export default function Daydream() {
  ...
  return (
    <Program
      ...
      description="Welcome to British Columbia's biggest upcoming youth hackathon! Daydream is a hackathon for high schoolers in the lower mainland, where you can explore all of your game development ideas! 
